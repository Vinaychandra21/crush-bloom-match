    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground">People who added you back! 💕</p>
        </div>
      </div>
      ...
      {matches.length === 0 ? (
        <Card className="shadow-soft">
          <CardContent className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-8 max-w-md mx-auto">
              Don't worry! Matches are processed regularly. Keep adding people
              you're interested in and check back soon.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Good things take time. Your perfect match might be just around
                  the corner.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  The more people you add, the higher your chances of finding a
                  match.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Our algorithm works in the background to find mutual
                  connections.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-6">
          {matches.map((match) => {
            ...
            const yourPriority = isUser1
              ? match.user1_priority
              : match.user2_priority;
            const theirPriority = isUser1
              ? match.user2_priority
              : match.user1_priority;
            ...
            return (
              <Card
                key={match.id}
                className="shadow-romantic hover:shadow-glow transition-all duration-300"
              >
                <CardHeader>
                ...
                <CardContent className="space-y-6">
                  <div className="text-center p-6 bg-gradient-soft rounded-lg">
                    ...
                    <h3 className="text-xl font-semibold mb-2">
                      {otherUserProfile?.crushPhoneNumber || "Unknown"}
                    </h3>
                  ...
                  <div className="flex gap-3">
                    <Button
                      onClick={() =>
                        handleCall(otherUserProfile?.crushPhoneNumber || "")
                      }
                      className="flex-1"
                      variant="love"
                    >
                    ...
                    <Button
                      onClick={() =>
                        handleMessage(otherUserProfile?.crushPhoneNumber || "")
                      }
                      className="flex-1"
                      variant="outline"
                    >
